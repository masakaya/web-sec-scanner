...
echo ""
echo -e "${BLUE}1. Run fast scan with Bearer authentication:${NC}"
echo "uv run poe fast-scan -- http://juice-shop:3000 \\"
echo "  --auth-type bearer \\"
echo "  --auth-token \"${TOKEN}\""
echo ""
echo -e "${BLUE}2. Run thorough scan with Bearer authentication:${NC}"
echo "uv run poe thorough-scan -- http://juice-shop:3000 \\"
echo "  --auth-type bearer \\"
echo "  --auth-token \"${TOKEN}\""
echo ""
